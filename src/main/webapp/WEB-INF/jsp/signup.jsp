...
<div class="simple-page-form animated flipInY" id="signup-form">
	...
	<form action="#">
		...
		<div class="form-group">
			<input id="sign-up-email" type="text" class="form-control" placeholder="Username">
		</div>
		...
		<div class="form-group">
			<input id="sign-up-password" type="password" class="form-control" placeholder="Confirm Password">
		</div>
