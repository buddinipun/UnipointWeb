...
<head>
	...
	<title>-Unipoint - Webportal</title>
...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="../index.html" class="navbar-brand">
      ...
      <span class="brand-name">Unipoint</span>
    </a>
  </div><!-- .navbar-header -->
          ...
          <div class="media-group dropdown-menu animated flipInY">
              ...
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="../../UnipointWeb/resources/assets/images/221.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="../../UnipointWeb/resources/assets/images/205.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="../../UnipointWeb/resources/assets/images/207.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="../../UnipointWeb/resources/assets/images/211.jpg" alt="">
                    <i class="status status-away"></i>
                  </div>
                </div>
                <div class="media-body">
    ...
    <div class="media">
      <div class="media-left">
        <div class="avatar avatar-md avatar-circle">
          <a href="javascript:void(0)"><img class="img-responsive" src="../../UnipointWeb/resources/img/admin.jpg" alt="avatar"/></a>
        </div><!-- .avatar -->
      </div>
      <div class="media-body">
        <div class="foldable">
      ...
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">Campain Management</span>
            <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
          </a>
          <ul class="submenu">
            <li><a href="<%=request.getContextPath()%>/Offer">Create Offer</a></li>
          </ul>
        </li>
        ...
        <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="<%=request.getContextPath()%>/ActiveInactive">Active Inactive</a></li>
          </ul>
        </li>
         <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
          ...
          <ul class="submenu">
          <li><a href="<%=request.getContextPath()%>/EnableDisableCustomers">Customer Requests</a></li>
            <li><a href="<%=request.getContextPath()%>/BuzzedMe">Buzz Me</a></li>
          </ul>
        </li>
